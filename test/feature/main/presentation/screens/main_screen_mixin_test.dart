...
void main() {
  testWidgets('profile opens first and toggles extra menu on retap', (tester) async {
...
class _MainScreenMixinHarness extends StatefulWidget {
  ...
  @override
  State<_MainScreenMixinHarness> createState() => _MainScreenMixinHarnessState();
}

class _MainScreenMixinHarnessState extends State<_MainScreenMixinHarness> with MainScreenMixin<_MainScreenMixinHarness> {
  @override
