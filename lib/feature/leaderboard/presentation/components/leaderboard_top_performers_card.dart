...
class LeaderboardTopPerformersCard extends StatelessWidget {
  const LeaderboardTopPerformersCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Bounce(
      ...
      child: Column(
        ...
        children: [
        if (isFirst)
          Icon(LucideIcons.crown, color: const Color(0xFFFFD700), size: 28),
        ...
        Text(
          '$rank-o\'rin',
          style: context.textTheme.bodyXSmallSemibold.copyWith(
            color: context.appColors.grey,
          ),
        ),
