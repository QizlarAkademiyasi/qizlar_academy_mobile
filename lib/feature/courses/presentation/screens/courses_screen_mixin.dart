...
import 'package:qizlar_academy_mobile/feature/courses/presentation/components/courses_list_item_card.dart';
...
mixin CoursesScreenMixin<T extends StatefulWidget> on State<T> {
  ...
  void onSearchChanged(BuildContext context, String value) {
    context.read<CoursesCatalogBloc>().add(
      CoursesCatalogSearchChanged(query: value),
    );
  }
  ...
  void onNotificationTap(BuildContext context) {
    AppToast.info(
      context,
      title: 'Tez orada',
      message: 'Bildirishnomalar bo‘limi tez orada qo‘shiladi.',
    );
  }
