...
class CourseSubmitReviewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => CourseSubmitReviewBloc(getIt<CoursesRepository>(), courseId: id),
...
class _CourseSubmitReviewViewState extends State<CourseSubmitReviewView> with CourseSubmitReviewScreenMixin<CourseSubmitReviewView> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        bottom: false,
        child: BlocConsumer<CourseSubmitReviewBloc, CourseSubmitReviewState>(
          listenWhen: (previous, current) => previous.status != current.status,
          listener: submitReviewBlocListener,
          builder: (context, state) {
            final submitting = state.status == CourseSubmitReviewStatus.submitting;
            final commentFilled = submitReviewCommentController.text.trim().isNotEmpty;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                textAlign: TextAlign.center,
                                style: context.textTheme.bodyMediumRegular.copyWith(color: context.appColors.grey, height: 1.45),
                              ),
                              const SizedBox(height: 20),
                              CourseSubmitReviewStarPicker(rating: submitReviewRating, onChanged: onSubmitReviewRatingChanged),
                            ],
                          ),
                        ),
                        const SizedBox(height: 16),
                        Text(l10n.courseSubmitReviewYourCommentLabel, style: context.textTheme.bodySmallRegular.copyWith(color: context.appColors.grey)),
                        const SizedBox(height: 8),
                        Container(
                          decoration: BoxDecoration(
                            color: context.appColors.onContainer,
                          ...
                          child: Column(
                            ...
                            children: [
                              TextField(
                                ...
                                maxLines: 6,
                                maxLength: CourseSubmitReviewScreenMixin.maxCommentLength,
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: context.textTheme.bodyMediumRegular.copyWith(color: context.appColors.grey.withValues(alpha: 0.85)),
                              ...
                              Align(
                                ...
                                child: Text(
                                  l10n.courseSubmitReviewCharCount(
                                    submitReviewCommentController.text.length.clamp(0, CourseSubmitReviewScreenMixin.maxCommentLength),
                                    CourseSubmitReviewScreenMixin.maxCommentLength,
                                  ),
