...
sealed class Apis {
  ...
  /// - Nisbiy yo‘llar (`/uploads/...` yoki `uploads/...`) [imageBaseUrl] ga qarshi [Uri.resolve] qilinadi.
  static String resolveUrl(String raw) {
    ...
    final base = Uri.tryParse(imageBaseUrl);
...
sealed class UserApis {
  ...
  static const String quizCheckAnswer = '/api/v1/quiz/check-answer';
  ...
  static String notificationsReadById(String id) => '/api/v1/notification/$id/read';
